...
public class StockTwoPage extends TestAppPages {

	public float stockTwoPrice;
	public float stockTwoHigh;
	public float stockTwoLow;
	public float stockTwoEPS;
	
	public By stockTwoPriceField = By.xpath("/html[1]/body[1]/div[8]/div[1]/div[5]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[2]/sticky-header[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/g-card-section[1]/div[1]/g-card-section[1]/div[1]/span[1]/span[1]/span[1]");
	public By stockTwoAnnualHighField = By.xpath("/html[1]/body[1]/div[8]/div[1]/div[5]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[2]/sticky-header[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/g-card-section[2]/div[1]/g-flippy-carousel[1]/div[1]/div[1]/ol[1]/li[2]/div[1]/div[1]/table[1]/tbody[1]/tr[2]/td[2]");
	public By stockTwoAnnualLowField = By.xpath("/html[1]/body[1]/div[8]/div[1]/div[5]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[2]/sticky-header[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/g-card-section[2]/div[1]/g-flippy-carousel[1]/div[1]/div[1]/ol[1]/li[2]/div[1]/div[1]/table[1]/tbody[1]/tr[3]/td[2]");
	public By stockTwoEPSField = By.xpath("/html[1]/body[1]/div[8]/div[1]/div[5]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[2]/sticky-header[1]/div[2]/g-flippy-carousel[1]/div[1]/div[1]/ol[1]/li[1]/div[1]/div[4]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/g-card-section[1]/table[2]/tbody[1]/tr[3]/td[2]");
	WebDriverWait wait = new WebDriverWait(driver, 20);
	
	public StockTwoPage(RemoteWebDriver driver) {
		super(driver);
	}

	public float getCurrentStockPrice() {
		return this.stockTwoPrice;
	}
	...
	public void setCurrentStockPrice() {
		...
		//Set second stock price for summary and comparison later
		wait.until(ExpectedConditions.visibilityOfElementLocated(this.stockTwoPriceField));
		this.stockTwoPrice = Float.parseFloat(driver.findElement(this.stockTwoPriceField).getText());
	}
		
	public float getStockTwoAnnualHighField() {
		return this.stockTwoHigh;
	}

	public void setStockTwoAnnualHighField() {
		...
		//Set second stock 52-week high for summary and comparison later
		wait.until(ExpectedConditions.visibilityOfElementLocated(this.stockTwoAnnualHighField));
		this.stockTwoHigh = Float.parseFloat(driver.findElement(this.stockTwoAnnualHighField).getText());
	}

	public float getStockTwoAnnualLowField() {
		return this.stockTwoLow;
	}

	public void setStockTwoAnnualLowField() {
		//Set second stock 52-week low for summary and comparison later
		wait.until(ExpectedConditions.visibilityOfElementLocated(this.stockTwoAnnualLowField));
		this.stockTwoLow = Float.parseFloat(driver.findElement(this.stockTwoAnnualLowField).getText());
	}
	
	public float getStockTwoEPSField() {
		return this.stockTwoEPS;
	}
	
	public void setStockTwoEPSField() {
		...
		//Set second stock EPS for summary and comparison later
		wait.until(ExpectedConditions.visibilityOfElementLocated(this.stockTwoEPSField));
		this.stockTwoEPS = Float.parseFloat(driver.findElement(this.stockTwoEPSField).getText());
	}

    //Compare EPS and output which has a higher EPS
	public void compare(int choice){
		StockOnePage one = new StockOnePage(driver);
		System.out.println("Today's price of " + this.getCurrentStockPrice() + "is " + Math.round(((1-(this.getCurrentStockPrice()/this.getStockTwoAnnualHighField()))*100)) + "% lower than the 52 week high and " + Math.round(((this.getCurrentStockPrice()/this.getStockTwoAnnualLowField())-1)*100) + "% higher than the 52 week low." + System.lineSeparator());
		if (one.stockOneEPS > this.stockTwoEPS) {
			System.out.println("Stock One, " + one.getStockOneData(choice) + " has the higher EPS with an EPS of " + one.stockOneEPS + ".");
		}
		else {
			System.out.println("Stock Two, " + this.getStockTwoData(choice) + " has the higher EPS with an EPS of " + this.stockTwoEPS + ".");
		}
	}
