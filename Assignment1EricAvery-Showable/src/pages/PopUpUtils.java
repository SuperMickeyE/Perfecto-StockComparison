...
/** * @author mitchellw
    * This was obtained from the developers section of the Perfecto Mobile website:
    * http://developers.perfectomobile.com/display/TT/Pop-up+eliminator+framework 
    *
